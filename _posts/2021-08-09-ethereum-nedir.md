...
<picture>
  ...
  <img src="/assets/img/posts-img/eth/ethereum-fiyat.webp" alt="ethereum fiyatı" style="width:auto;">
</picture>
...
Rus kökenli Kanadalı Vitalik Buterin, kendi başına bir ün kazanan en tanınmış geliştiricidir. Orijinal 2013 Ethereum teknik incelemesinin yazarı Vitalik, Ethereum’un gelişimine aktif olarak katkıda bulunmaya devam etti ve platformu bu güne kadar iyileştirmeye devam ediyor. </p>
...
{% include how-to.html coinname="ethereum" coinlink="https://kripto.istanbul/ethereum-nedir/" step1text="Bir kripto para borsaları, kripto para birimi satın almanıza, satmanıza ve ticaret yapmanıza izin veren dijital bir platformdur. Hisse senedi alım satım platformlarına oldukça benzerdirler, ancak her borsanın kendine özgü özellikleri vardır. Bu noktada hangi borsadan işlem yapmak istediğinize karar vermek için birtakım kriterleri göz önünde bulundurmanız tavsiye edilir. İlk yapmanız gereken, başka bir kripto para birimiyle (BTC veya USDT gibi bir sabit para birimi gibi) ETH satın almak mı yoksa ABD doları gibi itibari para birimini mi yoksa TL, AUD, SGD veya EUR gibi kendi ülkenizin para birimini mi kullanmak istediğinize karar vermektir. Daha sonra, ücretlere ve para çekme seçeneklerine bakmalısınız. İdeal satın alım, düşük komisyon ücreti olan ve yüksek güvenlik özelliklerine sahip olan olacaktır. Yeni başlayan biri olarak, sizi bunaltabilecek, çok fazla özelliği olmayan, kolay bir kullanıcı arayüzüne sahip bir kripto para borsası seçmek en iyisidir." step2text="Kendinize uygun kripto para borsasını seçtikten sonra, siteye gidin ve adınız, e-posta adresiniz ve şifrenizle kaydolun. Not: Birçok borsa, ticaret yapmanıza izin vermeden önce tam adınızı, iletişim bilgilerinizi ve kimlik belgenizi ister." step3text="ETH satın almak için öncelikle döviz kuru itibari para birimi hesabınıza USD veya TL gibi desteklenen başka bir itibari para birimi yatırmanız veya kredi kartınızı hesaba bağlamanız gerekir. Borsanız Ethereum (ETH) destekliyorsa, yerel düzenlemelere bağlı olarak doğrudan banka kartınızla ETH satın alabilirsiniz. Bazı borsalar, satın aldığınız ETH miktarına bağlı olarak değişen komsiyon ücretleri alır, bu nedenle işleminizin maliyetine dikkat edin." step4text="İstediğiniz ETH eşleşmesini bulmak için seçtiğiniz borsadaki piyasalar bölümüne gidin. ETH satın alma bölümüne bakın ve harcamak istediğiniz eşleştirilmiş kripto para biriminin miktarını veya satın almak istediğiniz ETH miktarını yazın.Not: İşlemi tamamlamadan önce satın aldığınız ETH miktarı ve satın almanın toplam maliyeti dahil olmak üzere işlem ayrıntılarınızı dikkatlice inceleyin. Bütün bir Ether satın almanız gerekmediğini unutmayın, çoğu borsa bir tanesinin bir kısmını satın almanıza izin verir. Bazı kripto para borsaları, kripto para satın almanın yalnızca bir yolunu sunarken, diğerleri size birkaç seçenek sunar. Kripto para satın almanın en popüler yöntemleri anında satın alma ve spot piyasadır." %}
